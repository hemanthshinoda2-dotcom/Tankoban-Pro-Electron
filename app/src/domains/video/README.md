...
## Splits (AI-friendly)
- **video.js** remains the main Videos domain file (entrypoint from `index.html`).
- **video_utils.js** contains small pure helper utilities used by `video.js` (global-search helpers).  
  Loaded **before** `video.js` via `index.html`.
